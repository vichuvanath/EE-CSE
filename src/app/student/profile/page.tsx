...
export default function StudentProfilePage() {
  ...
  const onSubmit = async (values: ProfileFormValues) => {
    ...
    try {
      ...
      setToastMessage("Profile name updated successfully in academic register.");
  ...
  return (
    <div className="space-y-6">
      ...
      <PageHeader
        ...
        description="Verify your official enrollment profile synchronized with the Controller of Examinations."
        breadcrumbs={[
      ...
      <div className="bg-white rounded-2xl border border-slate-200/90 p-6 md:p-8 shadow-xs flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
        <div className="flex items-center gap-5">
          ...
          <div>
            <div className="flex items-center gap-2.5">
              ...
              <span className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-[11px] font-semibold bg-emerald-50 text-[#0F5132] border border-emerald-200">
        ...
        <div className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-slate-50 border border-slate-200 text-xs text-slate-600 font-mono">
          <span>ROLE:</span>
          <span className="font-bold text-[#0F5132] uppercase">{profile?.role || "STUDENT"}</span>
        </div>
      </div>
      ...
      <div className="bg-white rounded-2xl border border-slate-200/90 shadow-xs overflow-hidden">
        <div className="p-6 border-b border-slate-100">
          ...
          <p className="text-xs text-slate-500 mt-0.5">
            Strict institutional safeguards: Roll number and official email are read-only and locked to your registration.
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <p className="mt-1.5 text-[11px] text-slate-400">
                Enter your official given name as recognized in semester hall tickets.
              </p>
            </div>
            ...
            <div>
              ...
              />
              <p className="mt-1.5 text-[11px] text-slate-400">
                Issued by Controller of Examinations. Cannot be altered.
              </p>
            </div>
            ...
            <div>
              ...
              <input
                type="text"
                value="STUDENT — PROJECT REVIEW TRACK"
                disabled
                className="w-full px-3.5 py-2.5 rounded-lg border border-slate-200 bg-slate-50 text-slate-500 text-sm font-mono cursor-not-allowed"
              />
            </div>
      ...
      {/* Governance Banner */}
      <div className="bg-slate-50 rounded-xl border border-slate-200 p-4 flex items-start gap-3 text-xs text-slate-600">
        <ShieldAlert className="w-4 h-4 text-amber-600 shrink-0 mt-0.5" />
        <p leading-relaxed>
          <strong>Academic Governance Policy:</strong> Your student record is linked directly to your Team Dossier. Name corrections are audited and synchronized with semester marksheets and viva voce documentation.
        </p>
      </div>
    </div>
  );
